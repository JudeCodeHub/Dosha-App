      ...
      <div className="relative w-full bg-white/90 dark:bg-white/5 backdrop-blur-xl border border-zinc-200 dark:border-white/10 rounded-3xl shadow-lg shadow-zinc-200/60 dark:shadow-stone-900/60 px-8 py-12 sm:px-14 sm:py-16 text-center overflow-hidden transition-colors duration-300">
        ...
        <div className="relative mb-6 flex justify-center">
          <div className="w-20 h-20 rounded-full bg-linear-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-lg shadow-orange-300/50">
            ...
            >
              <path
                d="M32 8c0 0-8 10-8 18s8 10 8 10 8-2 8-10S32 8 32 8z"
                opacity="0.9"
              />
              <path
                d="M14 22c0 0 6 6 14 12s4 12 4 12-8-2-14-10S14 22 14 22z"
                opacity="0.75"
              />
              <path
                d="M50 22c0 0-6 6-14 12s-4 12-4 12 8-2 14-10S50 22 50 22z"
                opacity="0.75"
              />
              <path
                d="M8 38c0 0 8 2 16 0 6-2 8-8 8-8s-4 10-10 14S8 38 8 38z"
                opacity="0.6"
              />
              <path
                d="M56 38c0 0-8 2-16 0-6-2-8-8-8-8s4 10 10 14S56 38 56 38z"
                opacity="0.6"
              />
            </svg>
          </div>
        ...
        <p className="relative text-zinc-600 dark:text-stone-400 text-lg leading-relaxed max-w-md mx-auto mb-3">
          {t(
            ...
            "Uncover your unique mind-body constitution rooted in the ancient wisdom of ",
          )}
          <span className="font-medium text-zinc-800 dark:text-stone-300">
            {t("quiz.intro.subtitle_p2", "Ayurveda")}
          </span>
          .
        </p>
