    ...
    <main className="px-4 py-20 flex flex-col items-center justify-center relative overflow-hidden w-full h-full">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <p className="text-lg md:text-xl text-stone-600 dark:text-stone-300 max-w-2xl leading-relaxed mb-12">
          MarinZen helps you discover your Ayurvedic body constitution (Prakriti) 
          and provides personalized guidance for diet, lifestyle, yoga, skincare, and daily wellness 
          routines. Based on your unique Dosha, MarinZen creates a balanced path toward better health.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full px-4">
          <div className="bg-white/60 dark:bg-stone-800/40 backdrop-blur-md border border-stone-200/50 dark:border-stone-700/50 rounded-2xl p-6 text-left hover:bg-white/80 dark:hover:bg-stone-800/60 transition-colors duration-300">
            ...
            <h3 className="text-lg font-bold text-stone-800 dark:text-stone-200 mb-2">Discover Your Dosha</h3>
            <p className="text-sm text-stone-600 dark:text-stone-400">Understand your natural body constitution.</p>
          </div>
          ...
          <div className="bg-white/60 dark:bg-stone-800/40 backdrop-blur-md border border-stone-200/50 dark:border-stone-700/50 rounded-2xl p-6 text-left hover:bg-white/80 dark:hover:bg-stone-800/60 transition-colors duration-300">
            ...
            <h3 className="text-lg font-bold text-stone-800 dark:text-stone-200 mb-2">Personalized Wellness</h3>
            <p className="text-sm text-stone-600 dark:text-stone-400">Get diet, yoga, and lifestyle guidance.</p>
          </div>
          ...
          <div className="bg-white/60 dark:bg-stone-800/40 backdrop-blur-md border border-stone-200/50 dark:border-stone-700/50 rounded-2xl p-6 text-left hover:bg-white/80 dark:hover:bg-stone-800/60 transition-colors duration-300">
            ...
            <h3 className="text-lg font-bold text-stone-800 dark:text-stone-200 mb-2">Holistic Balance</h3>
            <p className="text-sm text-stone-600 dark:text-stone-400">Improve physical and mental wellbeing.</p>
          </div>
        </div>
