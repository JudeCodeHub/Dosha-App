        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 w-full px-2 sm:px-4">
          <div className="bg-white/60 dark:bg-stone-800/40 backdrop-blur-md border border-stone-200/50 dark:border-stone-700/50 rounded-2xl p-5 sm:p-6 text-left hover:bg-white/80 dark:hover:bg-stone-800/60 transition-colors duration-300">
            ...
            <h3 className="text-base sm:text-lg font-bold text-stone-800 dark:text-stone-200 mb-2">
              {t("intro.features.discovery.title")}
            </h3>
            <p className="text-sm text-stone-600 dark:text-stone-400">
              {t("intro.features.discovery.description")}
            </p>
          </div>
          ...
          <div className="bg-white/60 dark:bg-stone-800/40 backdrop-blur-md border border-stone-200/50 dark:border-stone-700/50 rounded-2xl p-5 sm:p-6 text-left hover:bg-white/80 dark:hover:bg-stone-800/60 transition-colors duration-300">
            ...
            <h3 className="text-base sm:text-lg font-bold text-stone-800 dark:text-stone-200 mb-2">
              {t("intro.features.customization.title")}
            </h3>
            <p className="text-sm text-stone-600 dark:text-stone-400">
              {t("intro.features.customization.description")}
            </p>
          </div>
          ...
          <div className="bg-white/60 dark:bg-stone-800/40 backdrop-blur-md border border-stone-200/50 dark:border-stone-700/50 rounded-2xl p-5 sm:p-6 text-left hover:bg-white/80 dark:hover:bg-stone-800/60 transition-colors duration-300">
            ...
            <h3 className="text-base sm:text-lg font-bold text-stone-800 dark:text-stone-200 mb-2">
              {t("intro.features.holistic.title")}
            </h3>
            <p className="text-sm text-stone-600 dark:text-stone-400">
              {t("intro.features.holistic.description")}
            </p>
          </div>
        </div>
      </div>
