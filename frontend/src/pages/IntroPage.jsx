...
export const IntroPage = () => {
  ...
  return (
    <main className="min-h-screen px-4 py-16 sm:py-20 flex flex-col items-center justify-center relative overflow-x-hidden w-full">
      ...
      {/* Background glows */}
      <div className="pointer-events-none absolute -top-32 -left-32 w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] rounded-full bg-orange-900/20 blur-3xl opacity-60" />
      <div className="pointer-events-none absolute bottom-10 right-10 w-[200px] sm:w-[400px] h-[200px] sm:h-[400px] rounded-full bg-amber-900/10 blur-3xl opacity-50" />
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 w-full px-2 sm:px-4">
          <div className="bg-white/60 dark:bg-stone-800/40 backdrop-blur-md border border-stone-200/50 dark:border-stone-700/50 rounded-2xl p-5 sm:p-6 text-left hover:bg-white/80 dark:hover:bg-stone-800/60 transition-colors duration-300">
            ...
            <h3 className="text-base sm:text-lg font-bold text-stone-800 dark:text-stone-200 mb-2">{t('intro.features.discovery.title')}</h3>
          ...
          <div className="bg-white/60 dark:bg-stone-800/40 backdrop-blur-md border border-stone-200/50 dark:border-stone-700/50 rounded-2xl p-5 sm:p-6 text-left hover:bg-white/80 dark:hover:bg-stone-800/60 transition-colors duration-300">
            ...
            <h3 className="text-base sm:text-lg font-bold text-stone-800 dark:text-stone-200 mb-2">{t('intro.features.customization.title')}</h3>
          ...
          <div className="bg-white/60 dark:bg-stone-800/40 backdrop-blur-md border border-stone-200/50 dark:border-stone-700/50 rounded-2xl p-5 sm:p-6 text-left hover:bg-white/80 dark:hover:bg-stone-800/60 transition-colors duration-300">
            ...
            <h3 className="text-base sm:text-lg font-bold text-stone-800 dark:text-stone-200 mb-2">{t('intro.features.holistic.title')}</h3>
